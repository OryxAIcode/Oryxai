...
class CodeSecConfigurable : Configurable {
    ...
    private val enabledCheckbox     = JCheckBox("OryxAI enabled")
    private val scanOnSaveCheckbox  = JCheckBox("Scan on save")
    private val scanOnPasteCheckbox = JCheckBox("Scan on paste")
    private val showInlineCheckbox  = JCheckBox("Show inline warnings")
